...
export function CalendarGrid({
  ...
  const isTripDay = (day: Date) => {
    const parsedStart = parseDateValue(trip.startDate);
    const parsedEnd = parseDateValue(trip.endDate);
    
    const tripStart = startOfDay(parsedStart ?? startOfDay(new Date()));
    const tripEnd = endOfDay(parsedEnd ?? endOfDay(new Date()));
              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  ...
                  className={cn(
                    ...
                    "hover:bg-[var(--chip-bg)]/80 hover:border-[var(--chip-border)]/80 active:scale-[0.98]",
                    ...
                    "data-[hidden=true]:hidden",
                    "group-data-[mode=compact]/mode:rounded-lg group-data-[mode=compact]/mode:px-2 group-data-[mode=compact]/mode:py-1.5 group-data-[mode=compact]/mode:text-[12px] group-data-[mode=compact]/mode:font-semibold group-data-[mode=compact]/mode:gap-1.5 group-data-[mode=compact]/mode:min-h-[36px]",
                    "group-data-[mode=micro]/mode:rounded-md group-data-[mode=micro]/mode:px-1.5 group-data-[mode=micro]/mode:py-1.5 group-data-[mode=micro]/mode:text-[11px] group-data-[mode=micro]/mode:font-medium group-data-[mode=micro]/mode:items-center group-data-[mode=micro]/mode:gap-1.5 group-data-[mode=micro]/mode:min-h-[28px]",
                  )}

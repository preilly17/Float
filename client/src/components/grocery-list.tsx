            ...
            <section className="rounded-2xl border border-border/60 bg-white p-5 shadow-sm dark:border-white/10 dark:bg-slate-900">
              ...
              <div className="mt-4 space-y-4">
                {isLoadingGroceries ? (
                  ...
                  <div className="rounded-xl border border-dashed border-border/60 bg-muted/20 px-4 py-6 text-center dark:border-white/10 dark:bg-slate-900/60">
                    <p className="text-base font-medium text-muted-foreground mb-1">Your list is empty</p>
                    <p className="text-sm text-muted-foreground">Click "Add item" above to start your grocery list</p>
                  </div>
                ) : (
                  <>
